...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f81b481bcf8, const void *arg_0x7f81b481a020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f81b479a618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f81b4551020), 
int (*key_eq_fn)(void *arg_0x7f81b4551798, void *arg_0x7f81b4551a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f81b434d610, int arg_0x7f81b434d878);
static double RandomUniform(void );
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(190U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 582
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(70U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }
...
#line 555
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(69U, "SRTreeC", "DistrMsg enqueue failed!!! \n");
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f81b3f49a90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f81b3f49a90) {
#line 78
    case 22:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f81b3f49a90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f81b3f47670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f81b3f47670, msg, payload, len);
#line 78
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(188U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(189U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (sendDone == SUCCESS) 
    ...
    {
      sim_log_debug(74U, "SRTreeC", "send failed!!!\n");
    }
}
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(192U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(193U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__sendDistrTask__runTask(void )
{
  ...
  if (SRTreeC__DistrSendQueue__empty()) 
    {
      sim_log_debug(75U, "SRTreeC", "sendDistrTask(): Q is empty!\n");
      return;
    }

  if (SRTreeC__DistrSendBusy[sim_node()] == TRUE) 
    {
      sim_log_debug(76U, "SRTreeC", "sendDistrTask(): Q is empty!\n");
      return;
    }
  ...
  if (numMsgSent == 1) {
      ...
      if (mlen != sizeof(DistrMsg1 )) 
        {
          sim_log_debug(77U, "SRTreeC", "\t\t sendDistrTask(): Unknown message!!\n");
          return;
        }
    }
  else {
#line 691
    if (numMsgSent == 2) {
        ...
        if (mlen != sizeof(DistrMsg2 )) 
          {
            sim_log_debug(78U, "SRTreeC", "\t\t sendDistrTask(): Unknown message!!\n");
            return;
          }
      }
    else {
#line 700
      if (numMsgSent == 3) {
          ...
          if (mlen != sizeof(DistrMsg3 )) 
            {
              sim_log_debug(79U, "SRTreeC", "\t\t sendDistrTask(): Unknown message!!\n");
              return;
            }
        }
      else {
          ...
          if (mlen != sizeof(DistrMsg4 )) 
            {
              sim_log_debug(80U, "SRTreeC", "\t\t sendDistrTask(): Unknown message!!\n");
              return;
            }
        }
      }
  ...
  if (sendDone == SUCCESS) 
    ...
    {
      sim_log_debug(81U, "SRTreeC", "sendDistrTask(): Send returned failed!!!\n");
    }
}
...
#line 831
            ...
            {
              sim_log_debug(84U, "SRTreeC", "receiveDistrTask():Empty message!!! \n");
              return;
            }
        }
      }
  ...
  if (err == SUCCESS) 
    {
      ...
      if (TOS_NODE_ID == 0) 
        {
          sim_log_debug(57U, "SRTreeC", "###########START ROUTING###############\n\n");
...
static inline void SRTreeC__RadioControl__stopDone(error_t err)
{
  sim_log_debug(58U, "Radio", "Radio stopped!\n");
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f81b3f50970, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f81b3f50970, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f81b39ee318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f81b39ee318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f81b39ee318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f81b4227108){
#line 75
  switch (arg_0x7f81b4227108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f81b4227108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f81b39ed488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f81b39ed488, addr, msg, len);
#line 80
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(186U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 298
  ...
  if (SRTreeC__RoutingSendQueue__full()) 
    {
      sim_log_debug(59U, "SRTreeC", "RoutingSendQueue is FULL!!! \n");
      return;
    }
...
#line 343
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(61U, "SRTreeC", "RoutingMsg failed to be enqueued in SendingQueue!!!");
    }
}
...
#line 380
  ...
  sim_log_debug(62U, "SRTreeC", "numMsgSent %d\n", numMsgSent);



  if (SRTreeC__DistrSendQueue__full()) 
    {
      sim_log_debug(63U, "SRTreeC", "DistrSendQueue is FULL!!! \n");
      return;
    }

  randVal = SRTreeC__RandomGen__rand16() % 50;

  sim_log_debug(64U, "SRTreeC", "Random value generated %d\n", randVal);
...
#line 426
          ...
          for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN && __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].senderID.nxdata) != 0; SRTreeC__i[sim_node()]++) {
              (__nesc_temp42 = mrpkt4->field4b.nxdata, __nesc_hton_uint16(__nesc_temp42, __nesc_ntoh_uint16(__nesc_temp42) + __nesc_ntoh_uint8(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].count.nxdata)));
              (__nesc_temp43 = mrpkt4->field4a.nxdata, __nesc_hton_uint16(__nesc_temp43, __nesc_ntoh_uint16(__nesc_temp43) + __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].sum.nxdata)));
              (__nesc_temp44 = mrpkt4->field4c.nxdata, __nesc_hton_uint16(__nesc_temp44, __nesc_ntoh_uint16(__nesc_temp44) + __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].sumofSquares.nxdata)));
              if (chooseFun1 == 1 || chooseFun2 == 1) {
...
#line 510
      ...
      if (enqueueDone == SUCCESS) 
        ...
        {
          sim_log_debug(68U, "SRTreeC", "DistrMsg failed to be enqueued in SendingQueue!!!");
        }
    }
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f81b3a912f8){
#line 83
  switch (arg_0x7f81b3a912f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f81b3a912f8);
#line 83
      break;
#line 83
    }
