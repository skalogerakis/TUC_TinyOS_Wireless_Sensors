...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f5968190cf8, const void *arg_0x7f596818f020);
#line 774
...
#line 260
extern double erfc(double arg_0x7f596810f618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f5967ec6020), 
int (*key_eq_fn)(void *arg_0x7f5967ec6798, void *arg_0x7f5967ec6a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f5967cc2610, int arg_0x7f5967cc2878);
static double RandomUniform(void );
...
#line 679
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(82U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }
...
#line 652
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(81U, "SRTreeC", "DistrMsg enqueue failed!!! \n");
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f596788aa90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f596788aa90) {
#line 78
    case 22:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f596788aa90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f5967889670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f5967889670, msg, payload, len);
#line 78
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  if (len == sizeof(RoutingMsg )) 
    ...
    {
      sim_log_debug(95U, "SRTreeC", "receiveRoutingTask():Empty message!!! \n");
      return;
    }
}
...
static inline void SRTreeC__sendDistrTask__runTask(void )
{
  ...
  if (SRTreeC__DistrSendBusy[sim_node()] == TRUE) 
    {
      sim_log_debug(88U, "SRTreeC", "sendDistrTask(): Q is empty!\n");
      return;
    }
...
#line 797
      if (numMsgSent == 3) {
          ...
          if (mlen != sizeof(DistrMsg4 )) 
            {
              sim_log_debug(92U, "SRTreeC", "\t\t sendDistrTask(): Unknown message!!\n");
              return;
            }
        }
      }
  ...
  if (sendDone == SUCCESS) 
    ...
    {
      sim_log_debug(93U, "SRTreeC", "sendDistrTask(): Send returned failed!!!\n");
    }
}
  ...
  if (err == SUCCESS) 
    {
      ...
      if (TOS_NODE_ID == 0) 
        {
          sim_log_debug(62U, "SRTreeC", "###########START ROUTING###############\n\n");
...
static inline void SRTreeC__RadioControl__stopDone(error_t err)
{
  sim_log_debug(63U, "Radio", "Radio stopped!\n");
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f5967891970, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f5967891970, msg, error);
#line 110
}
#line 110
...
#line 531
  ...
  sim_log_debug(158U, "CpmModelC", "ReadRssi: noise %f\n", noise);
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f5967330318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f5967330318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f5967330318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f5967b9c108){
#line 75
  switch (arg_0x7f5967b9c108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f5967b9c108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f596732f488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f596732f488, addr, msg, len);
#line 80
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(133U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(134U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 358
      ...
      sim_log_debug(141U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(142U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(143U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(144U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(145U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(146U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
              sim_log_debug_clear(147U, "CpmModelC", " scheduling ack.\n");
              CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
            }
          else {
              CpmModelC__free_receive_message(mine);
      ...
      CpmModelC__receiving[sim_node()] = 0;
      sim_log_debug_clear(148U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 407
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(149U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 430
    if (!CpmModelC__shouldReceive(power - noiseStr)) {
        sim_log_debug(150U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 434
...
#line 437
        if (CpmModelC__receiving[sim_node()]) {
            sim_log_debug(151U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
            rcv->lost = 1;
          }
        else {
#line 441
          if (CpmModelC__transmitting[sim_node()] && rcv->start < CpmModelC__transmissionEndTime[sim_node()] && CpmModelC__transmissionEndTime[sim_node()] <= rcv->end) {
              sim_log_debug(152U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC__transmissionEndTime[sim_node()]);
              rcv->lost = 1;
            }
          else {
...
#line 449
  ...
  while (list != (void *)0) {
      ...
      if (!CpmModelC__shouldReceive(list->power - rcv->power)) {
          sim_log_debug(153U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 471
  sim_log_debug(154U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 480
  ...
  sim_log_debug(155U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 487
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(156U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 500
{
  ...
  sim_log_debug(157U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC__transmitting[sim_node()], sim_time_string());
}
...
#line 360
  ...
  if (SRTreeC__RoutingSendQueue__full()) 
    {
      sim_log_debug(64U, "SRTreeC", "RoutingSendQueue is FULL!!! \n");
      return;
    }
  ...
  if (mrpkt == (void *)0) 
    {
      sim_log_debug(65U, "SRTreeC", "RoutingMsgTimer.fired(): No valid payload... \n");
      return;
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 387
...
#line 390
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(66U, "SRTreeC", "RoutingMsg failed to be enqueued in SendingQueue!!!");
    }
}
...
#line 137
{
  sim_log_debug(56U, "SRTreeC", "#### OUTPUT: \n");
  sim_log_debug(57U, "SRTreeC", "#### [COUNT] = %d\n", __nesc_ntoh_uint16(mrpkt->field4b.nxdata));
  sim_log_debug(58U, "SRTreeC", "#### [SUM] = %d\n", __nesc_ntoh_uint16(mrpkt->field4a.nxdata));
  if (chooseFun1 == 1 || chooseFun2 == 1) {
      sim_log_debug(59U, "SRTreeC", "#### [MIN] = %d\n", __nesc_ntoh_uint16(mrpkt->field4d.nxdata));
    }
  else 
#line 143
    {
      sim_log_debug(60U, "SRTreeC", "#### [MAX] = %d\n", __nesc_ntoh_uint16(mrpkt->field4d.nxdata));
    }
  sim_log_debug(61U, "SRTreeC", "#### [SUM OF SQUARES] = %d\n\n\n", __nesc_ntoh_uint16(mrpkt->field4c.nxdata));
}
...
#line 119
{
  sim_log_debug(51U, "SRTreeC", "#### OUTPUT: \n");

  if (chooseFun == 1) {
      sim_log_debug(52U, "SRTreeC", "#### [MIN] = %d\n\n\n", __nesc_ntoh_uint16(mrpkt->field1a.nxdata));
    }
  else {
#line 124
    if (chooseFun == 2) {
        sim_log_debug(53U, "SRTreeC", "#### [ΜΑΧ] = %d\n\n\n", __nesc_ntoh_uint16(mrpkt->field1a.nxdata));
      }
    else {
#line 126
      if (chooseFun == 3) {
...
#line 128
        {
          sim_log_debug(55U, "SRTreeC", "#### [SUM] = %d\n\n\n", __nesc_ntoh_uint16(mrpkt->field1a.nxdata));
        }
      }
    }
}
...
#line 428
  ...
  sim_log_debug(67U, "SRTreeC", "numMsgSent %d\n", numMsgSent);



  if (SRTreeC__DistrSendQueue__full()) 
    {
      sim_log_debug(68U, "SRTreeC", "DistrSendQueue is FULL!!! \n");
      return;
    }

  randVal = SRTreeC__RandomGen__rand16() % 50;

  sim_log_debug(69U, "SRTreeC", "Random value generated %d\n", randVal);
...
#line 477
      if (mrpkt1 == (void *)0) 
        {
          sim_log_debug(70U, "SRTreeC", "DistrMsgTimer.fired(): No valid payload... \n");
          return;
        }
    }
  else {
...
#line 502
          ...
          for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN && __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].senderID.nxdata) != 0; SRTreeC__i[sim_node()]++) {
              (__nesc_temp44 = mrpkt4->field4b.nxdata, __nesc_hton_uint16(__nesc_temp44, __nesc_ntoh_uint16(__nesc_temp44) + __nesc_ntoh_uint8(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].count.nxdata)));
              (__nesc_temp45 = mrpkt4->field4a.nxdata, __nesc_hton_uint16(__nesc_temp45, __nesc_ntoh_uint16(__nesc_temp45) + __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].sum.nxdata)));
              (__nesc_temp46 = mrpkt4->field4c.nxdata, __nesc_hton_uint16(__nesc_temp46, __nesc_ntoh_uint16(__nesc_temp46) + __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].sumofSquares.nxdata)));
              if (chooseFun1 == 1 || chooseFun2 == 1) {
...
#line 512
          ...
          if (mrpkt4 == (void *)0) 
            {
              sim_log_debug(71U, "SRTreeC", "DistrMsgTimer.fired(): No valid payload... \n");
              return;
            }
        }
      }
...
#line 537
      ...
      if (numMsgSent == 1) {
          ...
          if (chooseProg == 2 && !(abs(__nesc_ntoh_uint16(mrpkt1->field1a.nxdata) - SRTreeC__Vold[sim_node()]) > abs(SRTreeC__Vold[sim_node()]) * TCT)) {
              oldFlag = 1;
              sim_log_debug(73U, "SRTreeC", "Don't send message with new value %d and old value %d\n", __nesc_ntoh_uint16(mrpkt1->field1a.nxdata), SRTreeC__Vold[sim_node()]);
            }
          else {
#line 567
            if (chooseProg == 2) {
          ...
          if (oldFlag == 0) {
              ...
              if (chooseFun == 1) {
                  sim_log_debug(74U, "SRTreeC", "Node: %d , Parent: %d, min: %d, depth: %d\n", TOS_NODE_ID, SRTreeC__parentID[sim_node()], __nesc_ntoh_uint16(mrpkt1->field1a.nxdata), SRTreeC__curdepth[sim_node()]);
                }
              else {
#line 579
                if (chooseFun == 2) {
                    sim_log_debug(75U, "SRTreeC", "Node: %d , Parent: %d, max: %d, depth: %d\n", TOS_NODE_ID, SRTreeC__parentID[sim_node()], __nesc_ntoh_uint16(mrpkt1->field1a.nxdata), SRTreeC__curdepth[sim_node()]);
                  }
                else {
#line 581
                  if (chooseFun == 3) {
                      sim_log_debug(76U, "SRTreeC", "Node: %d , Parent: %d, count: %d, depth: %d\n", TOS_NODE_ID, SRTreeC__parentID[sim_node()], __nesc_ntoh_uint16(mrpkt1->field1a.nxdata), SRTreeC__curdepth[sim_node()]);
                    }
                  else 
#line 583
                    {
                      sim_log_debug(77U, "SRTreeC", "Node: %d , Parent: %d, sum: %d, depth: %d\n", TOS_NODE_ID, SRTreeC__parentID[sim_node()], __nesc_ntoh_uint16(mrpkt1->field1a.nxdata), SRTreeC__curdepth[sim_node()]);
                    }
                  }
                }
            }
...
#line 594
      ...
      if (oldFlag == 0) {
          ...
          if (enqueueDone == SUCCESS) 
            ...
            {
              sim_log_debug(80U, "SRTreeC", "DistrMsg failed to be enqueued in SendingQueue!!!");
            }
        }
    }
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f59673d22f8){
#line 83
  switch (arg_0x7f59673d22f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f59673d22f8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(185U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(184U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(181U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(182U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(174U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(164U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(170U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(171U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 45
{
  sim_log_debug(98U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
...
#line 364
{
  sim_log_debug(176U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(135U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(136U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 285
  ...
  sim_log_debug(173U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(179U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(159U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(160U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(161U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(162U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(180U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(183U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(172U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 91
{
  ...
  sim_log_debug(186U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 2) {
      ...
      sim_log_debug(187U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(188U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 2;
      ...
      sim_log_debug(189U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
