...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7fd7ec124cf8, const void *arg_0x7fd7ec123020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7fd7ec0a3618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fd7ebe5a020), 
int (*key_eq_fn)(void *arg_0x7fd7ebe5a798, void *arg_0x7fd7ebe5aa38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fd7ebc56610, int arg_0x7fd7ebc56878);
static double RandomUniform(void );
...
static inline void SRTreeC__rootMsgPrint(DistrMsg *mrpkt);
...
#line 238
  sim_log_debug(90U, "Packet", "Delivering packet to %i at %s\n", (int )sim_node(), sim_time_string());
...
#line 413
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(63U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(172U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 386
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(62U, "SRTreeC", "DistrMsg enqueue failed!!! \n");
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fd7eb893c98, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fd7eb893c98) {
#line 78
    case 22:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fd7eb893c98, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fd7eb891810, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fd7eb891810, msg, payload, len);
#line 78
...
static inline void SimSchedulerBasicP__Scheduler__init(void )
{
  sim_log_debug(77U, "Scheduler", "Initializing scheduler.\n");
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(64U, "SRTreeC", "sendRoutingTask(): Q is empty!\n");
      return;
    }
  ...
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(65U, "SRTreeC", "sendRoutingTask(): RoutingSendBusy= TRUE!!!\n");
  ...
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(66U, "SRTreeC", "\t\tsendRoutingTask(): Unknown message!!!\n");
  ...
  if (sendDone == SUCCESS) 
    ...
    {
      sim_log_debug(67U, "SRTreeC", "send failed!!!\n");
    }
}
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  if (len == sizeof(RoutingMsg )) 
    ...
    {
      sim_log_debug(73U, "SRTreeC", "receiveRoutingTask():Empty message!!! \n");
      return;
    }
}
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(170U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(171U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__sendDistrTask__runTask(void )
{
  ...
  if (SRTreeC__DistrSendQueue__empty()) 
    {
      sim_log_debug(68U, "SRTreeC", "sendDistrTask(): Q is empty!\n");
      return;
    }

  if (SRTreeC__DistrSendBusy[sim_node()] == TRUE) 
    {
      sim_log_debug(69U, "SRTreeC", "sendDistrTask(): Q is empty!\n");
      return;
    }
  ...
  if (mlen != sizeof(DistrMsg )) 
    {
      sim_log_debug(70U, "SRTreeC", "\t\t sendDistrTask(): Unknown message!!\n");
      return;
    }
  ...
  if (sendDone == SUCCESS) 
    ...
    {
      sim_log_debug(71U, "SRTreeC", "sendDistrTask(): Send returned failed!!!\n");
    }
}
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(174U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(175U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
  ...
  if (len == sizeof(DistrMsg )) 
    {
      ...
      DistrMsg *mr = (DistrMsg *)SRTreeC__DistrPacket__getPayload(&radioDistrRecPkt, len);
      ...
      for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN; SRTreeC__i[sim_node()]++) {
          if (source == __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].senderID.nxdata) || __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].senderID.nxdata) == 0) {
              ...
              __nesc_hton_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].count.nxdata, __nesc_ntoh_uint16(mr->count.nxdata));
              __nesc_hton_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].sum.nxdata, __nesc_ntoh_uint16(mr->sum.nxdata));
              __nesc_hton_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].max.nxdata, __nesc_ntoh_uint16(mr->max.nxdata));
              break;
            }
        }
    }
    ...
    {
      sim_log_debug(74U, "SRTreeC", "receiveDistrTask():Empty message!!! \n");
      return;
    }
}
...
static inline void SRTreeC__InitChildrenArray(void )
{
  for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN; SRTreeC__i[sim_node()]++) {
      ...
      __nesc_hton_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].count.nxdata, 0);
    }
}
  ...
  if (err == SUCCESS) 
    {
      ...
      if (TOS_NODE_ID == 0) 
        {
          sim_log_debug(51U, "SRTreeC", "###########START ROUTING###############\n\n");
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fd7eb89bb48, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fd7eb89bb48, msg, error);
#line 110
}
#line 110
...
#line 531
  ...
  sim_log_debug(135U, "CpmModelC", "ReadRssi: noise %f\n", noise);
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fd7eb33b318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fd7eb33b318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fd7eb33b318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fd7ebb30108){
#line 75
  switch (arg_0x7fd7ebb30108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fd7ebb30108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fd7eb339488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fd7eb339488, addr, msg, len);
#line 80
...
#line 269
  ...
  while (list != (void *)0) {
      sim_log_debug(110U, "CpmModelC", "checkReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(111U, "CpmModelC", "checkReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
...
#line 321
{
  ...
  sim_log_debug(114U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 336
    if (mine == CpmModelC__outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(115U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 342
  sim_log_debug(116U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC__checkReceive(mine)) {
      sim_log_debug(117U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
...
#line 358
      ...
      sim_log_debug(118U, "CpmModelC,SNRLoss", "-signaling reception\n");
      CpmModelC__Model__receive(mine->msg);
      if (mine->ack) {
          sim_log_debug(119U, "CpmModelC", "yes acknowledgment requested, \n");
        }
      else {
          sim_log_debug(120U, "CpmModelC", "no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
          sim_log_debug(121U, "CpmModelC", " scheduling ack.\n");
          CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
        }
      else {
          sim_log_debug(122U, "CpmModelC", " should not ack.\n");
          CpmModelC__free_receive_message(mine);
        }
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(123U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC__Model__shouldAck(mine->msg)) {
              sim_log_debug_clear(124U, "CpmModelC", " scheduling ack.\n");
              CpmModelC__sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
            }
          else {
              CpmModelC__free_receive_message(mine);
      ...
      CpmModelC__receiving[sim_node()] = 0;
      sim_log_debug_clear(125U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 407
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(126U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 430
    if (!CpmModelC__shouldReceive(power - noiseStr)) {
        sim_log_debug(127U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 434
...
#line 437
        if (CpmModelC__receiving[sim_node()]) {
            sim_log_debug(128U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
            rcv->lost = 1;
          }
        else {
#line 441
          if (CpmModelC__transmitting[sim_node()] && rcv->start < CpmModelC__transmissionEndTime[sim_node()] && CpmModelC__transmissionEndTime[sim_node()] <= rcv->end) {
              sim_log_debug(129U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC__transmissionEndTime[sim_node()]);
              rcv->lost = 1;
            }
          else {
...
#line 449
  ...
  while (list != (void *)0) {
      ...
      if (!CpmModelC__shouldReceive(list->power - rcv->power)) {
          sim_log_debug(130U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 471
  sim_log_debug(131U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 480
  ...
  sim_log_debug(132U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 487
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(133U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
#line 282
  ...
  sim_log_debug(102U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 253
{
  ...
  sim_log_debug(100U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(101U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 500
{
  ...
  sim_log_debug(134U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC__transmitting[sim_node()], sim_time_string());
}
...
#line 243
        TossimPacketModelC__sending[sim_node()] = (void *)0;
        sim_log_debug(99U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 194
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(98U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 161
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(96U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  if (!TossimPacketModelC__running[sim_node()]) {
      sim_log_error(97U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not running!\n");
      return EOFF;
    }
...
#line 244
  sim_log_debug(109U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 129
  if (__nesc_ntoh_uint16(header->dest.nxdata) == TossimActiveMessageC__amAddress()) {
      sim_log_debug(89U, "Acks", "Received packet addressed to me so ack it\n");
      return TRUE;
    }
  return FALSE;
}
...
#line 299
      ...
      if (msg != TossimPacketModelC__sending[sim_node()]) {
          ...
          sim_log_debug(103U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC__sending[sim_node()]);
        }
    }
}
...
#line 162
  sim_log_debug(106U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
static inline void SRTreeC__RoutingMsgTimer__fired(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__full()) 
    {
      sim_log_debug(53U, "SRTreeC", "RoutingSendQueue is FULL!!! \n");
      return;
    }
  ...
  if (mrpkt == (void *)0) 
    {
      sim_log_debug(54U, "SRTreeC", "RoutingMsgTimer.fired(): No valid payload... \n");
      return;
    }
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 247
...
#line 250
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(55U, "SRTreeC", "RoutingMsg failed to be enqueued in SendingQueue!!!");
    }
}
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(168U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 103
{
  ...
  sim_log_debug(47U, "SRTreeC", "#### [COUNT] = %d\n", __nesc_ntoh_uint16(mrpkt->count.nxdata));
  sim_log_debug(48U, "SRTreeC", "#### [SUM] = %d\n", __nesc_ntoh_uint16(mrpkt->sum.nxdata));
  sim_log_debug(49U, "SRTreeC", "#### [MAX] = %d\n", __nesc_ntoh_uint16(mrpkt->max.nxdata));
  sim_log_debug(50U, "SRTreeC", "#### [AVG] = %f\n\n\n", (double )__nesc_ntoh_uint16(mrpkt->sum.nxdata) / __nesc_ntoh_uint16(mrpkt->count.nxdata));
}
...
static inline void SRTreeC__DistrMsgTimer__fired(void )
{
  ...
  if (SRTreeC__DistrSendQueue__full()) 
    {
      sim_log_debug(56U, "SRTreeC", "DistrSendQueue is FULL!!! \n");
      return;
    }


  mrpkt = (DistrMsg *)SRTreeC__DistrPacket__getPayload(&tmp, sizeof(DistrMsg ));

  if (mrpkt == (void *)0) 
    {
      sim_log_debug(57U, "SRTreeC", "DistrMsgTimer.fired(): No valid payload... \n");
      return;
    }
  ...
  sim_log_debug(58U, "SRTreeC", "Random value generated %d\n", randVal);

  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 318
    {
      __nesc_hton_uint16(mrpkt->sum.nxdata, randVal);
      __nesc_hton_uint16(mrpkt->count.nxdata, 1);
      __nesc_hton_uint16(mrpkt->max.nxdata, randVal);
    }
#line 322
    __nesc_atomic_end(__nesc_atomic); }
  ...
  for (SRTreeC__i[sim_node()] = 0; SRTreeC__i[sim_node()] < MAX_CHILDREN && __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].senderID.nxdata) != 0; SRTreeC__i[sim_node()]++) {
      (__nesc_temp42 = mrpkt->count.nxdata, __nesc_hton_uint16(__nesc_temp42, __nesc_ntoh_uint16(__nesc_temp42) + __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].count.nxdata)));
      (__nesc_temp43 = mrpkt->sum.nxdata, __nesc_hton_uint16(__nesc_temp43, __nesc_ntoh_uint16(__nesc_temp43) + __nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].sum.nxdata)));
      __nesc_hton_uint16(mrpkt->max.nxdata, SRTreeC__maxFinder(__nesc_ntoh_uint16(SRTreeC__childrenArray[sim_node()][SRTreeC__i[sim_node()]].max.nxdata), __nesc_ntoh_uint16(mrpkt->max.nxdata)));
    }
  ...
  if (TOS_NODE_ID == 0) {
      ...
      sim_log_debug(59U, "SRTreeC", "\n\n########################Epoch %d completed#####################\n", SRTreeC__roundCounter[sim_node()]);
      SRTreeC__rootMsgPrint(mrpkt);
    }
  else 

    {

      sim_log_debug(60U, "SRTreeC", "Node: %d , Parent: %d, Sum: %d, count: %d, max: %d , depth: %d\n", TOS_NODE_ID, SRTreeC__parentID[sim_node()], __nesc_ntoh_uint16(mrpkt->sum.nxdata), __nesc_ntoh_uint16(mrpkt->count.nxdata), __nesc_ntoh_uint16(mrpkt->max.nxdata), SRTreeC__curdepth[sim_node()]);
      SRTreeC__DistrAMPacket__setDestination(&tmp, SRTreeC__parentID[sim_node()]);
      SRTreeC__DistrPacket__setPayloadLength(&tmp, sizeof(DistrMsg ));
      ...
      if (enqueueDone == SUCCESS) 
        ...
        {
          sim_log_debug(61U, "SRTreeC", "DistrMsg failed to be enqueued in SendingQueue!!!");
        }
    }
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fd7eb3dd2f8){
#line 83
  switch (arg_0x7fd7eb3dd2f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fd7eb3dd2f8);
#line 83
      break;
#line 83
    }
...
#line 45
{
  sim_log_debug(75U, "PlatformC", "Initialized mote.\n");
  return SUCCESS;
}
...
#line 86
{
  sim_log_debug(91U, "TossimPacketModelC", "TossimPacketModelC: Init.init() called\n");
...
#line 211
  ...
  sim_log_debug(85U, "SimMoteP", "Turning on mote %i at time %s.\n", (int )sim_node(), buf);
...
#line 210
    __nesc_atomic_end(__nesc_atomic); }
  if (result == SUCCESS) {
      sim_log_debug(80U, "Scheduler", "Posting task %hhu.\n", id);
      SimSchedulerBasicP__sim_scheduler_submit_event();
    }
  else {
      sim_log_debug(81U, "Scheduler", "Posting task %hhu, but already posted.\n", id);
    }
  return result;
}
...
#line 75
  ...
  sim_log_debug(76U, "SimMainP", "Mote %li signaling boot at time %s.\n", sim_node(), timeBuf);
  ...
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    {
      ...
      if (nextTask == SimSchedulerBasicP__NO_TASK) 
        {
          sim_log_debug(78U, "Scheduler", "Told to run next task, but no task to run.\n");
          {
...
#line 193
    __nesc_atomic_end(__nesc_atomic); }
#line 192
  sim_log_debug(79U, "Scheduler", "Running task %hhu.\n", nextTask);
...
#line 78
  sim_log_debug(86U, "AM", "AM: Sending packet (id=%hhu, len=%hhu) to %hu\n", id, len, addr);
...
#line 294
  noise = pow(10.0, noise / 10.0);
  while (list != (void *)0) {
      sim_log_debug(112U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  noise = 10.0 * log(noise) / log(10.0);
  sim_log_debug(113U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 131
{
  ...
  sim_log_debug(104U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(105U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
{
  if (!TossimPacketModelC__initialized[sim_node()]) {
      sim_log_error(92U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called before initialization!\n");
      return FAIL;
    }
  sim_log_debug(93U, "TossimPacketModelC", "TossimPacketModelC: Control.start() called.\n");
...
#line 91
{
  ...
  sim_log_debug(163U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] >= 2) {
      ...
      sim_log_debug(164U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(165U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__current[sim_node()] = 2;
      ...
      sim_log_debug(166U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 170
  ...
  sim_log_debug(83U, "SimMoteP", "Fetched %s of %i to be %p with len %i (result %i)\n", name, mote, *ptr, *len, result);
  sim_set_node(tmpID);
  return result;
}
...
#line 179
  ...
  sim_log_debug(84U, "SimMoteP", "Setting start time to %llu\n", SimMoteP__startTime[sim_node()]);
  sim_set_node(tmpID);
  return;
}
...
#line 124
{
  if (!SimMoteP__isOn[sim_node()]) {
      ...
      sim_log_debug(82U, "SimMoteP", "Setting start time to %llu\n", SimMoteP__startTime[sim_node()]);
